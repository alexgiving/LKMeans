...
PREPROCESS_COMPONENTS=(2 5 8 10 15)
DIMENSION_VALUES=(20)
...
NAME="${CLUSTERING}_|_self_supervision_${PREPROCESSOR}_|_num-clusters_${NUM_CLUSTERS}_|_minkowski_${MINKOVSKI}_|_t_${T}_|_n-points_${N_POINTS}_|_dimension_${DIMENSION}_|_repeats_${REPEATS}.log"
